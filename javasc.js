...
const main = document.createElement("main");
   main.setAttribute("style","display:flex; border:0px solid blue; flex: 1 1 0; margin: 0px;justify-content: center;");
 ...
 conts.forEach(cont => {
   cont.setAttribute("style","display: flex; flex-direction: column; margin: 0px; border: 0px; padding: 0px;;flex: 0 1 0; border: 1px solid yellow;");
 })
